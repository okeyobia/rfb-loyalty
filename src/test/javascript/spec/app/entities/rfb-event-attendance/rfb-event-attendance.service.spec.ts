...
describe('Service Tests', () => {
  describe('RfbEventAttendance Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a RfbEventAttendance', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            attendanceDate: currentDate.format(DATE_FORMAT)
      ...
      it('should update a RfbEventAttendance', async () => {
        const returnedFromService = Object.assign(
          {
            attendanceDate: currentDate.format(DATE_FORMAT)
          },
      ...
      it('should return a list of RfbEventAttendance', async () => {
        const returnedFromService = Object.assign(
          {
            attendanceDate: currentDate.format(DATE_FORMAT)
          },
      ...
      it('should delete a RfbEventAttendance', async () => {
